...
function buildVars(){
  ...
  music = {
    opening: "./music/101-opening.mp3",
    battle: "./music/107-battle (vs wild pokemon).mp3",
    victory: "./music/108-victory (vs wild pokemon) (1).mp3",
    pikachu: "./music/170-pikachu.mp3",
    charmander: "./music/149-charmander.mp3",
    squirtle: "./music/152-squirtle.mp3",
    bulbasaur: "./music/146-bulbasaur.mp3",
    machop: "./music/213-machop.mp3"
  }
